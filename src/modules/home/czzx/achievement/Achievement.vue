<template>
 ...
 <!--  <main class="content-main" role="main" v-html="'achievement'"> -->
		<ul class="info-list" v-show = "currentLang=='zh_hk'">
			...
			<li :class = "currentLang">
				<span class="square" :class = "currentLang"></span>1926年徐仁苺先生建饑，總會冠以“工商”二字範圍太狭窄，不利於團結廣大客家鄉親，遂決議稱為“香港崇正總會”。</li>
			<li :class = "currentLang">
				<span class="square" :class = "currentLang"></span>香港崇正總會在1922年至1940年期間，先後創辦了4間崇正義學，其經费概由會長胡文虎先生讚助。</li>
			<li :class = "currentLang">
				<span class="square" :class = "currentLang"></span>總會先後創辦了《崇正月刊》、《崇正會刊》,還出版过共15卷的《客族考源》一书。</li>
			<li :class = "currentLang">
