let zh_cn = {
  ...
  navs: [{
    ...
    name: "香港崇正中学",
    path: '/czzx',
    description: "创校之路，教育理念 ..."
  }, {
    name: "英国牛津国际公学",
    path: '/njgx',
    description: "亲善大使计划，个人发展 ..."
  }, {
    name: '课程概览',
    path: '/kcgl',
    description: "八至十二年级课程，专修课程"
  }, {
    name: "入学申请流程及收费",
    path: '/sblc',
    description: "申请资格，费用，申请流程 ..."
  }, {
    name: "光荣榜",
    path: '/honor',
    description: "历届荣誉榜"
...
let zh_hk = {
  ...
  navs: [{
    ...
    name: "香港崇正中學",
    path: '/czzx',
    description: "創校之路，教育理念 ..."
  }, {
    name: "英國牛津國際公學",
    path: '/njgx',
    description: "親善大使計劃，個人發展 ..."
  }, {
    name: '課程概覽',
    path: '/kcgl',
    description: "八至十二年級課程，專修課程"
  }, {
    name: "入學申請流程及收費",
    path: '/sblc',
    description: "申請資格，費用，申請流程 ..."
  }, {
    name: "光榮榜",
    path: '/honor',
    description: "歷屆榮譽榜"
  ...
  [
    {
      ...
      path: '/czzx',
      description: "The Establishment, Achievement over the post ..."
    }, {
      name: "UK Oxford International College",
      path: '/njgx',
      description: "The Establishment, Mission and Objective"
    }, {
      name: 'TTMS-OIC Programme Information',
      path: '/njkc',
      description: "Quality Assurance, Programme Structure ..."
    },, {
      name: 'Admission Guideline',
      path: '/rxsq',
      description: "Admission Requirements, Application Procedures ..."
    }, {
      name: "TTMS OIC Campus",
      path: '/njxy',
      description: "The School Site and Structure ..."
    }, {
      name: "Honorary List and Outstanding Candidates",
      path: '/honor',
      description: "Previous Honor List"
    }, {
      name: "Contacts and Photo Gallery",
      nameHtml: "Contacts",
      path: '/contact',
      imgUrl: "tick.png",
      imgClass: 'tick'
