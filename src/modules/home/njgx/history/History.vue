    ...
    <div class="part2-1 part2-1-2">
      ...
      <div class="member-four-experience part2-1-2-right">
        ...
        <div class="teacher-name-wrapper teacher-four-name-wrapper" v-show="currentLang=='zh_hk'">
          ...
          <span class="teacher-title">牛津國際公學創始人</span>
        </div>
        ...
        <ul class="experience-list-four info-list" v-show="currentLang=='zh_hk'">
          ...
          <li>
            <p><span class="square"></span>碩士 - 愛丁堡大學丨英國第6，世界第27</p>
          </li>
          <li>
            <p><span class="square"></span>博士 - 牛津大學丨英國第1，世界第1</p>
          </li>
          <li>
            <p><span class="square"></span>牛津大學 - 空間物理研究员(1989-1999)</p>
          </li>
          <li>
          ...
          <li>
            <p><span class="square"></span>創始人 ，Plan8 網球學院，深圳(2013)</p>
          </li>
        </ul>
      ...
      <div class="part2-1-3-bottom">
        ...
        <div class="part2-1-3-bottomRight">
          ...
          <ul class="info-list" v-show="currentLang=='en'">
            ...
            <li><span class="square"></span>Residential Qeography/Geography of St.George's College, University of Western Australia Tutor (for many years)</li>
      ...
      <div class="part2-1-4-bottom darkBule">
        ...
        <div class="part2-1-4-bottomRight">
          <ul class="info-list" v-show="currentLang=='zh_hk'">
            ...
            <li><span class="square"></span>2015年度諾貝爾傑出教育家獎</li>
          ...
          <ul class="info-list" v-show="currentLang=='en'">
            ...
            <li>
              ...
              Founder of the UK' s Number 1 ranked school for A- level results for 8 consecutive years(2010-2017)
            </li>
          </ul>
        </div>
...
<style type="text/css" src="./history.css"></style>
