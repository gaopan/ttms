  ...
  <main class="content-main" role="main">
  	<div class="part2-3 part2-3-1" v-show="currentLang=='zh_hk'">
			<p class="part2-3-1-title" :class = "currentLang">
				在英國牛津國際公學，學生將遵循他們個人專屬的全面性戰略規劃道路，最大限度地提高他們進入世界一流大學的機會。“全面性戰略規劃’’課程涉及學生的學術、職業和個人發展。學校的延展課程包括親善大使計劃、愛丁堡公爵計劃等。
			</p>
			...
			<div class="part2-programme-2">
				...
				<div class="programme-item">
					...
					<p class="programme-description">倫敦音樂戲劇藝術學院2級口語和聽力技能獎由英格蘭資格及考試監督辦公室和相應的監管機構認可。該獎項旨在培養英語、口語和肢體語言技能。學生還將學習如何使聲音語調與相應的觀眾和講話目的相匹配，並獲得有效口語交流和參與小組討論所需的知識和理解内容。</p>
				</div>
